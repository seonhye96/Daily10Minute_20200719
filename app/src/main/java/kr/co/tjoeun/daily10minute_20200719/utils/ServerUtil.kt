...
class ServerUtil { // new > kotlin file/class
...
//    ServerUtil 클래스의 static 함수 / 변수들을 저장할 공간.
    companion object {
...
//        로그인 요청을 해주는 기능
        fun postRequestLogin(context: Context, email:String, pw:String, handler:JsonReponseHandler?){
...
//        회원가입 요청을 해주는 기능
        fun putRequestSignUp(context: Context, email : String, pw : String, nickName : String, handler:JsonReponseHandler?){
